            ...
            <div id="autoheight" style="background-color: #222D32;height:auto;">
                ...
                <div class="panel-group " id="panelgroup">
                    ...
                    <div class="panel mypanel" id="firstpanel" style="border:none;">
                        ...
                        <div class=" panel-collapse collapse <%if(lists.get(0).getNavfname().equals("论坛推荐")){%>in<%}%>"
                            ...
                            <div class="panel-body" style="border: none; padding:0px 15px 0px 5px;">
                                <ul class="nav">
                                    ...
                                    %>
                                    <li>
                                        <a <%if(lists.get(i).getNavss().getNavsname().equals("本周牛贴")){%>style="background-color: #1A2226;color: #ffffff;" <%}%>
            ...
            <div id="content-header">
                <h3 style="margin:0px;" class="page-header">
                    ...
                    <a href="#" class="pull-right" style="font-size: xx-small"><span
                            class="glyphicon glyphicon-tag"></span>本周牛贴</a>
                </h3>
            </div>
                ...
                <div style="background-color: #ffffff;">
                    ...
                    <div style="padding: 10px 10px 0px 10px;" class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <%
                                List<PostInformation> weekrankings = (List<PostInformation>) request.getAttribute("weekrankings");
                                for (PostInformation postInformation : weekrankings) {
                            %>
                            <tbody>
                            <tr>
                                <td>
                                    <a href="../postController/postshow?postid=<%=postInformation.getPostid()%>&recordpage=../postController/weekranking"><%=postInformation.getPosttitle()%>
                                    </a></td>
