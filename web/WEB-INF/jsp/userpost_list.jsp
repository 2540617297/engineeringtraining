            ...
            <div id="autoheight" style="background-color: #222D32;height:auto">
                ...
                <div class="panel-group " id="panelgroup">
                    ...
                    <div class="panel mypanel" id="firstpanel" style="border:none;">
                        ...
                        <div class=" panel-collapse collapse<%if(lists.get(0).getNavfname().equals("个人中心")){%>in<%}%>"
                            ...
                            <div class="panel-body" style=" border: none; padding:0px 15px 0px 5px;">
                                <ul class="nav">
                                    ...
                                    %>
                                    <li>
                                        <a <%if(lists.get(i).getNavss().getNavsname().equals("我的帖子")){%>style="background-color: #1A2226;color: #ffffff;" <%}%>
            ...
            <div id="content-header">
                <h3 style="margin:0px;" class="page-header">
                    ...
                    <a href="equipment-information.jsp" class="pull-right" style="font-size: xx-small"><span
                            class="glyphicon glyphicon-tag"></span>我的帖子</a>
                </h3>
            </div>
                ...
                <div style="background-color: #ffffff;">
                    ...
                    <div style="padding: 10px 10px 0px 10px;" class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <%
                                List<User> userpostlists = (List<User>) request.getAttribute("userpostlists");
                                int nowpage = (int) request.getAttribute("nowpage");
                                int allpagenum = (int) request.getAttribute("allpagenum");
                                int pages = (int) request.getAttribute("page");
                                for (User user : userpostlists) {
                                    for (PostInformation postinformation :
                                            user.getPostInformation()) {

                            %>
                            <tbody>
                            <tr>
                                <td>
                                    <a href="../postController/postshow?postid=<%=postinformation.getPostid()%>&recordpage=../postController/userpost_list"><%=postinformation.getPosttitle()%>
                                    </a></td>
                                <td><%=user.getUsername()%>
                                </td>
                                ...
                                <td>
                                    <a href="alter?postid=<%=postinformation.getPostid()%>"
                                       class="btn btn-info  btn-xs alimit">编辑</a>
                    ...
                    <div class="text-center">
                        <ul class="pagination">
                            <li><a class="btn btn-default"
                                   href="../postController/userpost_list?getnowpage=0<%if(question!=null){%>&question=<%=question%><%}%>">首页</a>
                            </li>
                            <li><a class="btn btn-default"
                                   href="../postController/userpost_list?getnowpage=<%=nowpage-1%><%if(question!=null){%>&question=<%=question%><%}%>">上一页</a>
                            </li>
                            <li><a class="btn btn-default"
                                   href="../postController/userpost_list?getnowpage=<%=nowpage+1%><%if(question!=null){%>&question=<%=question%><%}%>">下一页</a>
                            </li>
                            <li><a class="btn btn-default"
                                   href="../postController/userpost_list?getnowpage=<%=allpagenum%><%if(question!=null){%>&question=<%=question%><%}%>">页尾</a>
                            </li>
                        </ul>
                    </div>
