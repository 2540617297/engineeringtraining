                            ...
                            <div class="panel-group " id="panelgroup" >
                                ...
                                <div class="panel mypanel" id="firstpanel" style="border:none;">
                                    <a class="panel-heading" id="firstpanelimpl"  data-toggle="collapse" data-parent="#panelgroup" data-target="#panel<%=lists.get(0).getNavss().getNavsid()%>">
                                        ...
                                        <span class="glyphicon <%if(lists.get(0).getNavfname().equals("用户管理专区")){%>glyphicon-chevron-down<%}else{%>glyphicon-chevron-left<%}%> pull-right"></span>

                                    </a>
                                    <div class=" panel-collapse collapse <%if(lists.get(0).getNavfname().equals("用户管理专区")){%>in<%}%>"  id="panel<%=lists.get(0).getNavss().getNavsid()%>">
                                        <div class="panel-body" style=" border: none; padding:0px 15px 0px 5px;">
                                            <ul class="nav">
                                                ...
                                                %>
                                                <li><a <%if(lists.get(i).getNavss().getNavsname().equals("用户管理")){%>style="background-color: #1A2226;color: #ffffff;" <%}%> href="<%=lists.get(i).getNavss().getNavsherf()%>?postnavs=<%=lists.get(i).getNavss().getNavsid()%>">
                ...
                <div class="col-lg-10" id="content-right" style="height: auto ;position: relative">
                    <div id="content-header">
                        <h3 style="margin:0px;" class="page-header">
                            User管理
                            <small>管理</small>
                            <a href="#" class="pull-right" style="font-size: xx-small"><span class="glyphicon glyphicon-tag"></span>user管理</a>
                        </h3>
                    </div>
                    ...
                    <div id="content" style="margin-bottom: 50px;height: 900px;">
                        ...
                        <div style="background-color: #ffffff;">
                            <form action="../adminController/userlists" role="form" class="form-horizontal">
                            ...
                            <div style="padding: 10px 10px 0px 10px;" class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <%
                                        List<User> userlists= (List<User>) request.getAttribute("userlists");
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><%if(user.getMark()==1){%>管理员<%}else{%>用户<%}%></td>
                                            <td>
                                                <a href="../userController/user_information?edituser=<%=user.getUsername()%>" class="btn btn-info  btn-xs alimit">编辑</a>
                                                <a href="#" class="btn btn-danger  btn-xs alimit" onclick="del(<%=user.getId()%>);">删除</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <%}%>
                            ...
                            <div class="text-center">
                                <ul class="pagination">
                                    <li><a class="btn btn-default" href="../adminController/userlists?getnowpage=0<%if(question!=null){%>&question=<%=question%><%}%>" >首页</a></li>
                                    <li><a class="btn btn-default" href="../adminController/userlists?getnowpage=<%=nowpage-1%><%if(question!=null){%>&question=<%=question%><%}%>" >上一页</a></li>
                                    <li><a class="btn btn-default" href="../adminController/userlists?getnowpage=<%=nowpage+1%><%if(question!=null){%>&question=<%=question%><%}%>">下一页</a></li>
                                    <li><a class="btn btn-default" href="../adminController/userlists?getnowpage=<%=allpagenum%><%if(question!=null){%>&question=<%=question%><%}%>">页尾</a></li>
                                </ul>
                            </div>
