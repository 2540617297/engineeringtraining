...
<div class="container main">
    ...
    <div class="tab">
        <form action="../userController/find" name="form" role="form" class="form-group-lg" method="post" onsubmit="return check();">
            <label id="label" style="padding-top:30px; letter-spacing: 10px;">用户登陆</label>
            <div class="form-group  form-inline text1" style="margin-top: 50px;">
                ...
                <input type="text" name="username" class="form-control" id="username" placeholder="请输入用户名" style="width: 300px; height: 50px;">
            </div>
            ...
            <div class="form-group form-inline text2 "style="margin-top: 30px;">
                ...
                <input type="password" name="password" class="form-control" id="password" placeholder="请输入密码" style="width: 300px; height: 50px;">
            </div>
            <button class="btn btn-default btn-lg" type="submit" style="width: 150px; font-weight: bolder;">登陆</button>
