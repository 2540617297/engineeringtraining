...
<head>
    ...
    <style>
        ...
        .w-e-text-container{
            height: 430px !important;/*!important是重点，因为原div是行内样式设置的高度300px*/
        }
...
<%
   ...
   int userid= (int) request.getAttribute("userid");
    ...
    if(mark!=null&&mark.equals("false")) {
        response.getWriter().write("<script>alert('发帖时间间隔太短，不能再两分钟内重复发帖！');</script>");
    }
                            ...
                            <div class=" panel-collapse collapse <%if(lists.get(0).getNavfname().equals("服务专区")){%>in<%}%>"  id="panel<%=lists.get(0).getNavss().getNavsid()%>">
                                <div class="panel-body" style=" border: none; padding:0px 15px 0px 5px;">
                                    <ul class="nav">
                                        ...
                                        %>
                                        <li><a <%if(lists.get(i).getNavss().getNavsname().equals("编辑服务")){%>style="background-color: #1A2226;color: #ffffff;" <%}%> href="<%=lists.get(i).getNavss().getNavsherf()%>">
                ...
                <div class="col-lg-10" id="content-right" style="height: auto ;position: relative">
                    <div id="content-header">
                        <h3 style="margin:0px;" class="page-header">
                            Service编写
                            <small>bianxie</small>
                            <a href="all_admin_index.jsp" class="pull-right" style="font-size: xx-small"><span class="glyphicon glyphicon-tag"></span>Service</a>
                        </h3>
                    </div>

                    <div id="content" style="margin-bottom: 50px">
                        <div style="background-color: #ffffff; padding:10px;height: calc(100vh - 200px)">
                            <div class="headline" >
                                <p >帖子编写</p>
                            </div>

                            <form action="serviceadd" class="form-group-lg" method="post">
                                <%--标题--%>
                                ...
                                <input type="hidden" name="serviceuser" value="<%=userid%>">
