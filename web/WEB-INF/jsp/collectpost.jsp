                                    ...
                                    <div class=" panel-collapse collapse <%if(lists.get(0).getNavfname().equals("个人中心")){%>in<%}%>"  id="panel<%=lists.get(0).getNavss().getNavsid()%>">
                                        <div class="panel-body" style=" border: none; padding:0px 15px 0px 5px;">
                                            <ul class="nav">
                                                ...
                                                %>
                                                <li><a <%if(lists.get(i).getNavss().getNavsname().equals("我收藏的帖子")){%>style="background-color: #1A2226;color: #ffffff;" <%}%> href="<%=lists.get(i).getNavss().getNavsherf()%>?postnavs=<%=lists.get(i).getNavss().getNavsid()%>">
                ...
                <div class="col-lg-10" id="content-right" style="height: auto ;position: relative">
                    <div id="content-header">
                        <h3 style="margin:0px;" class="page-header">
                            POST收藏
                            <small>收藏</small>
                            <a href="equipment-information.jsp" class="pull-right" style="font-size: xx-small"><span class="glyphicon glyphicon-tag"></span>POST收藏</a>
                        </h3>
                    </div>
                        ...
                        <div style="background-color: #ffffff;">
                            ...
                            <div style="padding: 10px 10px 0px 10px;" class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <%
                                        List<CollectPost> collectPosts= (List<CollectPost>) request.getAttribute("collectPosts");
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="../postController/postshow?postid=<%=collectPost.getPostInformation().getPostid()%>"> <%=collectPost.getPostInformation().getPosttitle()%></a></td>
                                            <td><%=collectPost.getUser().getUsername()%></td>
                                            <td><%=collectPost.getCollecttime()%></td>
                                            <td><%=collectPost.getNavS().getNavsname()%></td>
                                            <td><%=collectPost.getPostInformation().getPostview()%></td>
                                            <td>
                                                <a href="#" class="btn btn-danger  btn-xs alimit" onclick="userpostdel(<%=collectPost.getPostInformation().getPostid()%>)">删除</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <%}%>
                            ...
                            <div class="text-center">
                                <ul class="pagination">
                                    <li><a class="btn btn-default" href="../postController/collectpost?getnowpage=0" >首页</a></li>
                                    <li><a class="btn btn-default" href="../postController/collectpost?getnowpage=<%=nowpage-1%>" >上一页</a></li>
                                    <li><a class="btn btn-default" href="../postController/collectpost?getnowpage=<%=nowpage+1%>">下一页</a></li>
                                    <li><a class="btn btn-default" href="../postController/collectpost?getnowpage=<%=allpagenum%>">页尾</a></li>
                                </ul>
                            </div>
