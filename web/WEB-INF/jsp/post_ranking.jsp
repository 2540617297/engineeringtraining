                            ...
                            <div class="panel-group " id="panelgroup" >
                                ...
                                <div class="panel mypanel" id="firstpanel" style="border:none;">
                                    <a class="panel-heading active" id="firstpanelimpl"  data-toggle="collapse" data-parent="#panelgroup" data-target="#panel<%=lists.get(0).getNavss().getNavsid()%>">
                                        ...
                                        <span class="glyphicon <%if(lists.get(0).getNavfname().equals("论坛推荐")){%>glyphicon-chevron-down<%}else{%>glyphicon-chevron-left<%}%> pull-right"></span>

                                    </a>
                                    <div class=" panel-collapse collapse <%if(lists.get(0).getNavfname().equals("论坛推荐")){%>in<%}%>"  id="panel<%=lists.get(0).getNavss().getNavsid()%>">
                                        <div class="panel-body" style="border: none; padding:0px 15px 0px 5px;">
                                            <ul class="nav">
                                                ...
                                                %>
                                                <li><a <%if(lists.get(i).getNavss().getNavsname().equals("论坛牛贴")){%>style="background-color: #1A2226;color: #ffffff;" <%}%> href="<%=lists.get(i).getNavss().getNavsherf()%>?postnavs=<%=lists.get(i).getNavss().getNavsid()%>">
                ...
                <div class="col-lg-10" id="content-right" style="height: auto ;position: relative">
                    <div id="content-header">
                        <h3 style="margin:0px;" class="page-header">
                            论坛牛贴
                            <small>信息</small>
                            <a href="equipment-information.jsp" class="pull-right" style="font-size: xx-small"><span class="glyphicon glyphicon-tag"></span>本周牛贴</a>
                        </h3>
                    </div>

                    <div id="content" style="margin-bottom: 50px;height: 1100px;">
                        <%--列表头--%>
                        ...
                        <div style="background-color: #ffffff;">
                            ...
                            <div style="padding: 10px 10px 0px 10px;" class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <%
                                        List<User> postranking = (List<User>) request.getAttribute("postranking");
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="../postController/postshow?postid=<%=postInformation.getPostid()%>&recordpage=../postController/postranking"> <%=postInformation.getPosttitle()%></a></td>
                                            <td><%=postInformation.getUser().getUsername()%></td>
                                            <td><%=postInformation.getPosttime()%></td>
                                            <td><%=postInformation.getNavS().getNavsname()%></td>
                                            <td><%=postInformation.getPostview()%></td>
                                           <%-- <td>
                                                <a href="#" class="btn btn-info  btn-xs alimit">编辑</a>
                            ...
                            <div class="text-center">
                                <ul class="pagination">
                                    ...
                                    <li><a class="btn btn-default" >页尾</a></li>
                                </ul>
                            </div>
