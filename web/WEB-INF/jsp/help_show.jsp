                            ...
                            <div class=" panel-collapse collapse <%if(lists.get(0).getNavfname().equals("服务专区")){%>in<%}%>"  id="panel<%=lists.get(0).getNavss().getNavsid()%>">
                                <div class="panel-body" style=" border: none; padding:0px 15px 0px 5px;">
                                    <ul class="nav">
                                        ...
                                        %>
                                        <li><a <%if(lists.get(i).getNavss().getNavsname().equals("论坛帮助")){%>style="background-color: #1A2226;color: #ffffff;" <%}%> href="<%=lists.get(i).getNavss().getNavsherf()%>?postnavs=<%=lists.get(i).getNavss().getNavsid()%>">
                ...
                <div class="col-lg-10" id="content-right" style="height: auto ;position: relative">
                    ...
                    <div id="content" style="margin-bottom: 40px">
                        ...
                        <div class="text-center">
                            <ul class="pagination">
                                <li><a class="btn btn-default" href="../adminController/helpshow?getnowpage=0" >首页</a></li>
                                <li><a class="btn btn-default" href="../adminController/helpshow?getnowpage=<%=nowpage-1%>" >上一页</a></li>
                                <li><a class="btn btn-default" href="../adminController/helpshow?getnowpage=<%=nowpage+1%>">下一页</a></li>
                                <li><a class="btn btn-default" href="../adminController/helpshow?getnowpage=<%=allpagenum%>">页尾</a></li>
                            </ul>
                        </div>
