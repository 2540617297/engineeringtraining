...
<nav class="navbar navbar-inverse " style="background-color: #1A2226; margin: 0px; padding:0px;">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="">实验室管理</a>
        </div>
            ...
            <div id="autoheight" style="background-color: #222D32;">
                ...
                <div class="panel-group " id="panelgroup">
                    ...
                    <div class="panel mypanel" id="firstpanel" style="border:none;">
                        ...
                        <div class=" panel-collapse collapse <%if(lists.get(0).getNavfname().equals("用户管理专区")){%>in<%}%>"
                            ...
                            <div class="panel-body" style=" border: none; padding:0px 15px 0px 5px;">
                                <ul class="nav">
                                    ...
                                    %>
                                    <li>
                                        <a <%if(lists.get(i).getNavss().getNavsname().equals("帖子管理")){%>style="background-color: #1A2226;color: #ffffff;" <%}%>
                                           href="<%=lists.get(i).getNavss().getNavsherf()%>">
        ...
        <div class="col-lg-10" id="content-right" style="height: auto ;position: relative">
            <div id="content-header">
                <h3 style="margin:0px;" class="page-header">
                    ...
                    <a href="#" class="pull-right" style="font-size: xx-small"><span
                            class="glyphicon glyphicon-tag"></span>Post管理</a>
                </h3>
            </div>
            ...
            <div id="content" style="margin-bottom: 50px;height: 1056px;">
                ...
                <div style="background-color: #ffffff;">
                    <form action="../adminController/postlists" role="form" class="form-horizontal">
                    ...
                    <div style="padding: 10px 10px 0px 10px;" class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>
                                    <a href="../postController/postshow?postid=<%=postinformation.getPostid()%>&recordpage=../adminController/postlists"><%=postinformation.getPosttitle()%>
                                    </a></td>
                                ...
                                <td>
                                    <a href="#" class="btn btn-danger  btn-xs alimit"
                                       onclick="userpostdel(<%=postinformation.getPostid()%>)">删除</a>
                                </td>
                            </tr>
                            </tbody>
                            <%}%>
                    ...
                    <div class="text-center">
                        <ul class="pagination">
                            <li><a class="btn btn-default"
                                   href="../adminController/postlists?getnowpage=0<%if(question!=null){%>&question=<%=question%><%}%>">首页</a>
                            </li>
                            <li><a class="btn btn-default"
                                   href="../adminController/postlists?getnowpage=<%=nowpage-1%><%if(question!=null){%>&question=<%=question%><%}%>">上一页</a>
                            </li>
                            <li><a class="btn btn-default"
                                   href="../adminController/postlists?getnowpage=<%=nowpage+1%><%if(question!=null){%>&question=<%=question%><%}%>">下一页</a>
                            </li>
                            <li><a class="btn btn-default"
                                   href="../adminController/postlists?getnowpage=<%=allpagenum%><%if(question!=null){%>&question=<%=question%><%}%>">页尾</a>
                            </li>
                        </ul>
                    </div>
