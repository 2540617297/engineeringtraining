...
<%
    ...
    List<List<Reply>> replyLists = (List<List<Reply>>) request.getAttribute("replyLists");
            ...
            <div id="autoheight" style="background-color: #222D32;height:auto">
                ...
                <div class="panel-group " id="panelgroup">
                    ...
                    <div class="panel mypanel" id="firstpanel" style="border:none;">
                        ...
                        <div class=" panel-collapse collapse <%if(lists.get(0).getNavss().getNavsname().equals("个人资料")){%>in<%}%>"
                            ...
                            <div class="panel-body" style=" border: none; padding:0px 15px 0px 5px;">
                                <ul class="nav">
                                    ...
                                    %>
                                    <li>
                                        <a <%if(lists.get(i).getNavss().getNavsname().equals("我要发帖")){%>style="background-color: #1A2226;color: #ffffff;" <%}%>
        ...
        <div class="col-lg-10" id="content-right" style="height: auto ;position: relative">
            ...
            <div id="content" style="margin-bottom: 50px">
                <div style="background-color: #ffffff; padding:10px;height: auto">
                    ...
                    <form action="postadd" class="form-group-lg" method="post">
                        <%--标题--%>
                        ...
                        <div class="row posttitle">
                            <div class="input-group input-group-lg">
                                ...
                                <select class="form-control" name="postnavs">
                        ...
                        <input type="hidden" name="postuser" value="<%=userid%>">
